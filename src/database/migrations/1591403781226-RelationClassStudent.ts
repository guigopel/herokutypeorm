...
export default class RelationClassStudent1591403781226
  implements MigrationInterface {
  name = 'RelationClassStudent1591403781226';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "student_classes_class" ("studentId" integer NOT NULL, "classId" integer NOT NULL, CONSTRAINT "PK_9f2c655a5feb7cff342af016c8e" PRIMARY KEY ("studentId", "classId"))`,
    );
    await queryRunner.query(
